    ...
    Tables: {
      ...
      leave_applications: {
        Row: {
          ...
          advisor_reviewed_by: string | null
          created_at: string
          end_date: string
        ...
        Relationships: [
          {
            foreignKeyName: "leave_applications_advisor_reviewed_by_fkey"
            columns: ["advisor_reviewed_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "leave_applications_hod_reviewed_by_fkey"
